...
- Sistema de créditos: Free (5/mes), Pro (50/mes), Admin (ilimitado)
- Historial de optimizaciones por usuario
- Panel de admin para ver uso
...
Setup Supabase (ejecutar en SQL Editor de Supabase):
...
-- 3. Row Level Security — cada usuario solo ve sus datos
...
-- 4. Para dar plan Pro/Admin a un usuario (ejecutar como admin):
-- UPDATE profiles SET plan = 'pro' WHERE email = 'usuario@email.com';
-- UPDATE profiles SET plan = 'admin' WHERE email = 'tu@email.com';
"""
